...
app.run([
  ...
  function($templateCache) {
    $templateCache.put('formio/components/resource.html',
      ...
      '<ui-select ui-select-required ng-model="data[component.key]" ng-disabled="readOnly" ng-required="component.validate.required" id="{{ component.key }}" name="{{ component.key }}" theme="bootstrap">' +
