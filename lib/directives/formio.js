...
var _default = exports.default = app.directive('formio', function () {
  return {
    restrict: 'E',
    replace: true,
    scope: {
    ...
    controller: ['$scope', '$q', function ($scope, $q) {
      ...
      $scope.initializeForm = function () {
        ...
        if ($scope.src || $scope.form) {
          ...
          _embed.Formio.createForm($scope.element, $scope.src || $scope.form, _.cloneDeep($scope.options)).then(function (formio) {
