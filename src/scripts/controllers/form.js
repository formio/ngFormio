...
app.controller('FormController', [
  ...
  function(
    ...
    $scope.setEmbedCode = function(gotoUrl) {
      ...
      embedCode +=        'if (!f || (typeof w.seamless === "undefined")) {';
      ...
      embedCode += '</script>';
      embedCode += '<iframe id="formio-form-' + $scope.form._id + '" style="width:100%;border:none;" height="600px" src="https://form.io/view/#/' + $scope.currentProject.name + '/' + $scope.form.path + '?iframe=1&header=0"></iframe>';
