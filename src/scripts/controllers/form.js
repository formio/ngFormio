...
app.controller('FormShareController', [
  '$scope',
  '$stateParams',
  'AppConfig',
  'Formio',
  function(
    ...
    var loadPreview = function() {
      $scope.preview = 'http://localhost:8080/view/#/';
      $scope.preview += '?form=' + AppConfig.apiBase + '/project/' + $stateParams.projectId;
      $scope.preview += '/form/' + $stateParams.formId + '&';
      $scope.preview += $scope.options.showHeader ? 'header=1' : 'header=0';
