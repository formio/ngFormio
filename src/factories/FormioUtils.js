...
module.exports = function() {
  ...
  return {
    ...
    fieldWrap: function(input) {
      ...
      var inputTopLabel = '<label ng-if="component.label && !component.hideLabel && (component.labelPosition !== \'bottom\')" for="{{ component.key }}"  id="{{ component.key+\'Label\' }}" class="control-label" ng-class="{\'field-required\': isRequired(component)}" ng-style="getLabelStyles(component)">' +
        '{{ component.label | formioTranslate:null:options.building }} ' +
        '<formio-component-tooltip></formio-component-tooltip>' +
        '</label>';
      var inputBottomLabel = '<label ng-if="component.label && !component.hideLabel &&' +
