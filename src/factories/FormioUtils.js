...
module.exports = function() {
  ...
  return {
    ...
    fieldWrap: function(input) {
      ...
      var inputLabel = '<label formio-component-tooltip ng-if="component.label && !component.hideLabel" for="{{ component.key }}" class="control-label" ng-class="{\'field-required\': isRequired(component)}">' +
