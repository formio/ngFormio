Feature: Register Functionality
  ...
  Scenario: No username
    Given I am logged out
    When I enter ${random-email} in the .register-container #email field
    And I enter ${random-password>register.password} in the .register-container #password field
    And I enter ${register.password} in the .register-container #verifyPassword field
    Then the REGISTER button is disabled

  Scenario: No email
    Given I am logged out
    When I enter ${random-name} in the .register-container #name field
    And I enter ${random-password>register.password} in the .register-container #password field
    And I enter ${register-password} in the .register-container #verifyPassword field
    Then the REGISTER button is disabled
  ...
  Scenario: No password
    Given I am logged out
    When I enter ${random-email} in the .register-container #email field
    And I enter ${random-name} in the .register-container #name field
  ...
  Scenario: No verify password
    ...
    When I enter ${random-email} in the .register-container #email field
    And I enter ${random-name} in the .register-container #name field
    And I enter ${random-password} in the .register-container #password field
    Then the REGISTER button is disabled
  ...
  Scenario: Mismatched passwords
    Given I am logged out
    When I enter ${random-name} in the .register-container #name field
    And I enter ${random-email} in the .register-container #email field
    And I enter ${random-password} in the .register-container #password field
    And I enter ${random-password} in the .register-container #verifyPassword field
    Then the REGISTER button is disabled
  ...
  Scenario: Username unique
    ...
    And I am logged out
    When I enter ${register.name} in the .register-container #name field
    And I enter ${random-email} in the .register-container #email field
  ...
  Scenario: Email unique
    ...
    And I am logged out
    When I enter ${random-name>register3.name} in the .register-container #name field
    And I enter ${register2.email} in the .register-container #email field
  ...
  Scenario: Successful registration
    Given I am logged out
    When I enter ${random-name>register3.name} in the .register-container #name field
    And I enter ${random-email>register3.email} in the .register-container #email field
    And I enter ${random-password>register3.password} in the .register-container #password field
    And I enter ${register3.password} in the .register-container #verifyPassword field
    And I click the REGISTER button
