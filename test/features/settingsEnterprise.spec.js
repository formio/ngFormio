module.exports = function (actions) {
  describe('Enterprise  Plan Settings',function(){
    describe('Enterprise  Plan > Environment Settings',function(){
      ...
      actions.goToPage('#/project/59db96c33edc533dd059b810/overview');
      ...
      actions.checkingUrlIamOn('http://localhost:9002/#/project/59db96c33edc533dd059b810/env/settings/customjscss');
    });
    describe('Enterprise   Plan > Deployment Settings',function(){
      ...
      actions.checkingUrlIamOn('http://localhost:9002/#/project/59db96c33edc533dd059b810/env/staging/import');
      actions.clickOnElementWithText('Export Template');
      actions.checkingUrlIamOn('http://localhost:9002/#/project/59db96c33edc533dd059b810/env/staging/export');
    });
    describe('Enterprise Plan > Integrations Settings',function(){
      ...
      actions.checkingUrlIamOn('http://localhost:9002/#/project/59db96c33edc533dd059b810/env/integrations/info');
      actions.clickOnElementWithText('PDFs');
      actions.checkingUrlIamOn('http://localhost:9002/#/project/59db96c33edc533dd059b810/env/pdf');
