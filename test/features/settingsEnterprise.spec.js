module.exports = function (actions) {
  describe('Enterprise  Plan Settings',function(){
    describe('Enterprise  Plan > Environment Settings',function(){
      // actions.logout();
      // actions.enterTextInField('.register-container #name', '${random-name>register.name}');
      // actions.enterTextInField('.register-container #email', '${random-email>register.email}');
      ...
      // actions.logout();
      actions.enterTextInField('.login-container #email','test@1031');
      actions.enterTextInField('.login-container #password','pass');
