module.exports = function (actions) {
  describe('Teams 	- Creating/Deleting/Editing a team',function(){
    describe('Create ',function() {
      ...
      actions.checkingUrlEndsWith('/view');
      actions.clickOnClass('.caret.pull-right');
      actions.enterTextInFieldIndex('xpath://*[contains(@class,"form-control")]',1,'${login2.name}');
    ...
    describe('Team Owner',function() {
      ...
      actions.clickOnClass('.toast-message');
      actions.clickOnClass('.caret.pull-right');
      actions.enterTextInFieldIndex('xpath://*[contains(@class,"form-control")]',1,'${login4.name}');
      ...
      // actions.clickOnElementWithText('Beta Team');
      // actions.clickOnClass('.caret.pull-right');
      // actions.enterTextInFieldIndex('xpath://*[contains(@class,"form-control")]',1,'${login5.name}');
