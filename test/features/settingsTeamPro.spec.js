module.exports = function (actions) {
  describe('Team Pro Plan Settings',function(){
    describe('Team Pro Plan > Environment Settings',function(){
      ...
      actions.enterTextInField('#form-group-name>div.input-group.ng-scope>input','testteamproauto');
      actions.waitForActionToComplete(2000);
      actions.clickOnElementWithText(' Save Stage');
      actions.waitForActionToComplete(500);
      actions.iSeeValueIn('#form-group-name>div.input-group.ng-scope>input','testteamproauto');
      actions.clickOnElementWithText('Forms');
      actions.clickOnElementWithText('User Login');
      actions.iSeeTextIn('#form-group-path','API Path\nhttp://testteamproauto.localhost:3000/');
      actions.clickOnElementWithText('Resources');
      actions.clickOnElementWithText(' API');
      actions.iSeeTextIn('.wrap-table-cell','http://testteamproauto.localhost:3000/user');
      actions.clickOnElementWithText('Settings');
