...
describe("Formio Tests", function () {
  ...
  require('./features/nestedResource.spec')(actions);
  require('./features/apiTab.spec')(actions);
  require('./features/dataTab.spec')(actions);
  ...
  require('./features/formRevisions.spec')(actions);
  // require('./features/teams.spec')(actions);
  require('./features/projectUpgradePayment.spec')(actions);
  require('./features/welcomePage.spec')(actions);
  require('./features/overview.spec')(actions);
  // require('./features/skynurses.spec')(actions);
});
afterEach(function () {
